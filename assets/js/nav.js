...
const GUIDES = [
  ...
  },
  {
    ...
    subtitle: "Quadrants, TDLU, Cooper's ligaments, blood supply, lymphatics",
    pillar: "anatomy",
    tags: ["breast", "TDLU", "lymphatics", "Batson's plexus"],
    notionUrl: "",
    path: "/guides/anatomy/breast-anatomy.html",
    status: "complete",
  },
  {
    id: "axilla-lymph-nodes",
    title: "Axilla Anatomy & Lymph Node Levels",
    subtitle: "Levels I–III, boundaries, nerves at risk in axillary surgery",
    pillar: "anatomy",
    tags: ["breast", "axilla", "lymph nodes", "SLNB", "ALND"],
    notionUrl: "",
    path: "/guides/anatomy/axilla-lymph-nodes.html",
    status: "complete",
  },
  ...
  {
    id: "breast-cancer-histopathology",
    title: "Breast Cancer Histopathology & Receptor Status",
    subtitle: "Nottingham grading, ER/PR/HER2, Ki-67, HER2-low",
    pillar: "pathology",
    tags: ["breast", "histopathology", "receptor status", "HER2", "grading"],
    notionUrl: "",
    path: "/guides/pathology/breast-cancer-histopathology.html",
    status: "complete",
  },
  ...
  {
    id: "breast-cancer-invasive-insitu",
    title: "Breast Cancer — Invasive & In-Situ",
    subtitle: "DCIS vs LCIS, TNM staging, molecular subtypes, screening",
    pillar: "conditions",
    tags: ["breast", "oncology", "DCIS", "LCIS", "TNM", "molecular subtypes"],
    notionUrl: "",
    path: "/guides/conditions/breast-cancer-invasive-insitu.html",
    status: "complete",
  },
  {
    id: "benign-breast-disease",
    title: "Benign Breast Disease",
    subtitle: "Fibroadenoma, phyllodes, cysts, mastalgia, nipple discharge",
    pillar: "conditions",
    tags: ["breast", "fibroadenoma", "phyllodes", "nipple discharge", "ANDI"],
    notionUrl: "",
    path: "/guides/conditions/benign-breast-disease.html",
    status: "complete",
  },
  {
    id: "mastitis-breast-abscess",
    title: "Mastitis & Breast Abscess",
    subtitle: "Lactational vs non-lactational, periductal mastitis, drainage",
    pillar: "conditions",
    tags: ["breast", "mastitis", "abscess", "infection", "inflammatory cancer"],
    notionUrl: "",
    path: "/guides/conditions/mastitis-breast-abscess.html",
    status: "complete",
  },
  {
    id: "gynaecomastia",
    title: "Gynaecomastia",
    subtitle: "True vs pseudo, causes, male breast cancer differentiation",
    pillar: "conditions",
    tags: ["breast", "gynaecomastia", "male breast", "hormonal"],
    notionUrl: "",
    path: "/guides/conditions/gynaecomastia.html",
    status: "complete",
  },
  {
    id: "pagets-disease-nipple",
    title: "Paget's Disease of the Nipple",
    subtitle: "Eczema mimic, underlying DCIS/invasive cancer, biopsy",
    pillar: "conditions",
    tags: ["breast", "Paget's disease", "nipple", "DCIS", "oncology"],
    notionUrl: "",
    path: "/guides/conditions/pagets-disease-nipple.html",
    status: "complete",
  },
  ...
  {
    id: "triple-assessment-biopsy",
    title: "Triple Assessment & Image-Guided Biopsy",
    subtitle: "Core biopsy vs FNA, ultrasound/stereotactic guidance, B1–B5",
    pillar: "procedures",
    tags: ["breast", "triple assessment", "core biopsy", "FNA", "diagnostics"],
    notionUrl: "",
    path: "/guides/procedures/triple-assessment-biopsy.html",
    status: "complete",
  },
  {
    id: "breast-conserving-surgery",
    title: "Breast-Conserving Surgery & Oncoplastic Principles",
    subtitle: "Wide local excision, margin status, volume displacement/replacement",
    pillar: "procedures",
    tags: ["breast", "BCS", "oncoplastic", "wide local excision", "margins"],
    notionUrl: "",
    path: "/guides/procedures/breast-conserving-surgery.html",
    status: "complete",
  },
  {
    id: "mastectomy",
    title: "Mastectomy",
    subtitle: "Simple, skin-sparing, nipple-sparing — indications & reconstruction timing",
    pillar: "procedures",
    tags: ["breast", "mastectomy", "nipple-sparing", "skin-sparing"],
    notionUrl: "",
    path: "/guides/procedures/mastectomy.html",
    status: "complete",
  },
  {
    id: "axillary-surgery",
    title: "Axillary Surgery",
    subtitle: "SLNB technique, ACOSOG Z0011, ALND morbidity",
    pillar: "procedures",
    tags: ["breast", "axilla", "SLNB", "ALND", "Z0011"],
    notionUrl: "",
    path: "/guides/procedures/axillary-surgery.html",
    status: "complete",
  },
  {
    id: "breast-reconstruction",
    title: "Breast Reconstruction Overview",
    subtitle: "Implant-based vs autologous (DIEP, LD flap), timing, radiotherapy",
    pillar: "procedures",
    tags: ["breast", "reconstruction", "DIEP", "implant", "autologous"],
    notionUrl: "",
    path: "/guides/procedures/breast-reconstruction.html",
    status: "complete",
  },
];
